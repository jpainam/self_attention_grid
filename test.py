...
parser.add_argument('--test_dir', default='/home/paul/datasets/cuhk03/pytorch', type=str, help='./test_data')
...
print('-------test-----------')
if opt.use_dense:
    model_structure = DenseNetModel(1367)
else:
    model_structure = ResNetModel(1367)
